...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-svh w-full overflow-hidden">
      ...
      {/* ── Top white-to-transparent gradient (z-1) ───────────────────── */}
      <div
      ...
      <div className="relative z-[2] max-w-[1360px] mx-auto">
        ...
        <div className="flex flex-col items-center px-6 pt-16 pb-24 text-center">
          {/* Headline */}
          <h1 className="font-sans font-medium text-wandor-text leading-[1.05] tracking-[-0.04em] max-w-[820px] mb-5"
          ...
          >
            {/* Prompt text */}
            <p
              className="absolute font-sans text-xl max-md:text-[17px] font-medium text-wandor-prompt leading-relaxed break-words"
              style={{
                left: '29px',
                top: '57px',
                transform: 'translateY(-50%)',
                width: 'min(609px, calc(100% - 58px))',
              }}
            >
            ...
            <button
              ...
              className="absolute w-11 h-11 bg-transparent border border-white/70 rounded-full cursor-pointer flex items-center justify-center backdrop-blur-[14px] transition-transform hover:scale-105 focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2"
              style={{ left: '21px', top: '137px' }}
            >
            ...
            <button
              type="button"
              className="absolute w-[156px] h-14 bg-black border-none rounded-[44px] shadow-[0_0_2px_0_rgba(0,0,0,0.05)] cursor-pointer flex items-center justify-center font-sans text-base font-medium text-[#fafafa] uppercase tracking-[0.02em] transition-all hover:bg-[#333] active:scale-95"
